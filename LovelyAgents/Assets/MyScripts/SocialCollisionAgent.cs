...
public class SocialCollisionAgent : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.gameObject.tag == "Agent")
        {
            ...
            transform.parent.GetComponent<SocialAgent>().SetRandomDestination();
    ...
    void OnTriggerExit2D(Collider2D other)
    {
        if (other.gameObject.tag == "Agent")
        {
            ...
            transform.parent.GetComponent<SocialAgent>().obstacleNearby = 6;
